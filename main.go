...
import (
	...
	"github.com/kaladaOpuiyo/node-role-controller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "42d792e6.node.role.controller.io",
	})
	if err != nil {
	...
	if err = (&controllers.NodeRoleControllerReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("NodeRoleController"),
